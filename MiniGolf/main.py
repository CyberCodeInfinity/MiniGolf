...
# FONTS
myFont = pygame.font.SysFont('DestructoBeam BB', 50)
parFont = pygame.font.SysFont('DestructoBeam BB', 30)
...
class scoreSheet():
    def __init__(self, parr):
        ...
        self.width = 400
        self.height = 510
        self.font = pygame.font.SysFont('DestructoBeam BB', 22)
        self.bigFont = pygame.font.SysFont('DestructoBeam BB', 30)
...
def redrawWindow(ball, line, shoot=False, update=True):
    ...
    smallFont = pygame.font.SysFont('DestructoBeam BB', 20)
